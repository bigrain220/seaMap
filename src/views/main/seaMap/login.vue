<template>
  <div class="login-container">
    <div class="left-container">
      <div class="title"><span>智能调度系统</span></div>
...
<script>
import { loginAPI } from "@/api/seamap";
...
export default {
  ...
  mounted() {
    ...
    // const userName = localStorage.getItem('map_userName');
    // if(userName){
    //   this.$router.replace('/seamap/map')
    // }
  },
  methods: {
    loginClick() {
      ...
      loginAPI(userName, password).then((data) => {
            ...
            _this.$router.replace('/seamap/map');
          }
      ).catch((data) => {
